...
def _remove_padding_in_sequences(items: List) -> List:
    ...
    """
    for item in items:
        seq, act_log_prob, base_act_log_prob, rollout_log_prob, value, ret, adv, att_mask, act_mask = (
            item.sequences,
        ...
        (
            ...
            rollout_log_prob[:right_pad] if item.rollout_log_probs is not None else None,
